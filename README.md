...
30 august 2023 -- we need to edit our guessing game just like what our teacher said. we need to save all the instruction in a text file and the game will use that text file for referencing. the teacher show us some example
